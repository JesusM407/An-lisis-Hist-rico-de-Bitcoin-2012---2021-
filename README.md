...
1. **Crecimiento Exponencial:** La escala logarítmica revela que, pese a las correcciones, la tendencia de largo plazo se mantiene alcista.
2. **Hitos de Precio:** El análisis SQL identificó que el máximo histórico del dataset ocurrió en noviembre de 2021 superando los $69,000.
3. **Estabilización:** (Aquí puedes poner algo que hayas notado en tus gráficas).
